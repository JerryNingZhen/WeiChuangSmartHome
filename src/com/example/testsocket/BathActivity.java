...
public class BathActivity extends FullscreenActivity {
	...
	class checkall implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Toast air = Toast.makeText(BathActivity.this, "查看整体监测数据", Toast.LENGTH_LONG);
			air.show();
    ...
    class clickaircontrol implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		if(a%2==1){
    			...
    			Toast air = Toast.makeText(BathActivity.this, "空调开启", Toast.LENGTH_LONG);
				air.show();
    		}else{
    			...
    			Toast air = Toast.makeText(BathActivity.this, "关闭", Toast.LENGTH_LONG);
				air.show();
    		}
    	}
    }
	class touchsuncontrol implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(event.getAction()==MotionEvent.ACTION_DOWN){
				...
				Toast sun = Toast.makeText(BathActivity.this, "打开所有灯光", Toast.LENGTH_LONG);
				sun.show();
			}
	...
	class touchsleepcontrol implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(event.getAction()==MotionEvent.ACTION_DOWN){
				...
				Toast sleep = Toast.makeText(BathActivity.this, "关闭所有灯光", Toast.LENGTH_LONG);
				sleep.show();
			}
			else if(event.getAction()==MotionEvent.ACTION_UP){
	...
	class touchhome implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(event.getAction()==MotionEvent.ACTION_DOWN){
				...
				Toast home = Toast.makeText(BathActivity.this, "已切换到客厅", Toast.LENGTH_LONG);
				home.show();
				Intent intent = new Intent();
	...
	class touchsleep implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(event.getAction()==MotionEvent.ACTION_DOWN){
				...
				bath.setBackgroundResource(R.drawable.bath);
				Toast sleep = Toast.makeText(BathActivity.this, "已切换到卧室", Toast.LENGTH_LONG);
				sleep.show();
				Intent intent = new Intent();
	...
	class touchbath implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(event.getAction()==MotionEvent.ACTION_DOWN){
				...
				home.setBackgroundResource(R.drawable.home);
				sleep.setBackgroundResource(R.drawable.sleep);
				Toast bath = Toast.makeText(BathActivity.this, "您已在浴室界面", Toast.LENGTH_LONG);
				bath.show();
			}
			return false;
		}
    ...
    class light1button implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		if(c%2==1){
    			...
    			Toast light = Toast.makeText(BathActivity.this, "灯光开启", Toast.LENGTH_LONG);
				light.show();
    		}else{
    			light1button.setBackgroundResource(R.drawable.lightbuttonoff);
    			...
    			Toast light = Toast.makeText(BathActivity.this, "灯光关闭", Toast.LENGTH_LONG);
				light.show();
    		}
    	}
    }
    ...
    class monitor implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		Toast light = Toast.makeText(BathActivity.this, "监控开启", Toast.LENGTH_LONG);
			light.show();
    ...
    class water implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		if(d%2==1){
    			...
    			Toast light = Toast.makeText(BathActivity.this, "窗帘开启", Toast.LENGTH_LONG);
				light.show();
    		}else{
    			water.setBackgroundResource(R.drawable.certainoff);
    			
    			socketThread.Send("d");
    			Toast light = Toast.makeText(BathActivity.this, "窗帘关闭", Toast.LENGTH_LONG);
				light.show();
    		}
    	}
    }
    ...
    class tvon implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		if(e%2==1){
    			...
    			Toast light = Toast.makeText(BathActivity.this, "电视开启", Toast.LENGTH_LONG);
				light.show();
    		}else{
    			tvon.setBackgroundResource(R.drawable.tvoff);
    			Toast light = Toast.makeText(BathActivity.this, "电视关闭", Toast.LENGTH_LONG);
				light.show();
    		}
    	}
    }
	...
	class airdowntouch implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
            ...
            if(temp>=16){
				Toast sun = Toast.makeText(BathActivity.this, "温度降低为"+temp+"℃", Toast.LENGTH_LONG);
				sun.show();
            }else{
            	temp=16;
            	Toast sun = Toast.makeText(BathActivity.this, "温度已调至最低16℃", Toast.LENGTH_LONG);
				sun.show();
            }
			return false;
		}
	...
	class airuptouch implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(temp<=30){
				Toast sun = Toast.makeText(BathActivity .this, "温度提升为"+temp+"℃", Toast.LENGTH_LONG);
				sun.show();
            }else{
            	temp=30;
            	Toast sun = Toast.makeText(BathActivity .this, "温度已调至最高30℃", Toast.LENGTH_LONG);
				sun.show();
            }
			return false;
		}
